...
public class ArrayQueue<E> extends AbstractQueue<E> implements Queue<E> {
	 ...
	 * 
	 * @return the first item in the queue if successful; return null if the
	 *         queue is empty
	 */
	@Override
	public E peek() {
	...
	/**
	 * Removes the first item in the queue and returns it if the queue is not
	 * empty.
	 * 
	...
	/*public void removeFirst() {
		E[] newItems = (E[]) new Object[theItems.length-1];
		if (labReallocate) {
			int j = first+1;
